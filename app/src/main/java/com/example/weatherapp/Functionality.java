...
public class Functionality {
    ...
    // all icons are from openweathermap.org, not from me!!
    /**
     ...
     *
     * Note that an API key is required for OpenWeatherMap. It is stored as a secret.
     *
...
//                        textView2.setText(response);
        ...
        StringRequest stringRequest2 = new StringRequest(Request.Method.GET, url2, response -> {
            try {
                ...
                // this every 37 times. This is going to be annoying.
                for(int i = 0; i <= 37; i++) {
